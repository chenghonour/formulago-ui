...
run-docker:
	...
	docker run -d --name ${DOCKER_USERNAME}/backendui:${VERSION} -p 80:80 -v backendui:/etc/nginx --network docker-compose_formula-admin ${DOCKER_USERNAME}/backendui:${VERSION}